...
public class AdaptadorPersona extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        //Declarar Variable
        TextView cajaCedula,cajaNombre,cajaApellido,cajaTelefono;
        ImageView foto;
        ...
        cajaTelefono=(TextView)itemView.findViewById(R.id.txtTelefonoP);
        ...
        cajaTelefono.setText(personas.get(position).getTelefono());
